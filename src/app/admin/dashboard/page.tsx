    ...
    <aside className="hidden md:flex flex-col w-64 bg-[#0A0A0A] border-r border-white/5 min-h-screen p-4 fixed top-0 left-0 bottom-0 z-10 text-slate-300">
      ...
      <nav className="flex-1 space-y-1.5">
        <Link
          ...
          className="flex items-center gap-3 px-4 py-3 rounded-xl bg-teal-500/10 text-teal-400 font-medium text-sm transition-all"
        >
        ...
        <Link
          href="/admin/orders"
          className="flex items-center gap-3 px-4 py-3 rounded-xl text-slate-400 hover:bg-white/5 hover:text-white font-medium text-sm transition-all"
        >
