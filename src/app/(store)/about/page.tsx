...
const pillars = [
  ...
  },
  {
    ...
    desc: "مصنّعة فالمغرب وفق بروتوكولات الجودة الصيدلانية، ومصادق عليها (ONSSA).",
  },
  {
    icon: Lock,
    title: "خصوصية تامة",
      ...
      <section className="section-padding bg-white content-auto">
        <div className="container-max max-w-3xl">
          <div className="prose-custom space-y-6 text-charcoal leading-relaxed text-lg">
            ...
            <p>
              كل تركيبة كنطلقوها كتدوز من بروتوكول صارم: اختيار مكونات نباتية نشطة لها تاريخ موثق، صياغتها بمشاركة صيادلة، مصادقتها (ONSSA)، وأخيراً اختبارها مع زبونات حقيقيات.
            </p>
