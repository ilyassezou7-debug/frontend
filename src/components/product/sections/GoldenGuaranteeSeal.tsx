      ...
      <div className="container-max relative">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h2 className="font-display font-bold text-3xl md:text-4xl mb-4 leading-tight">
            30 يوماً لتجربة المنتج دون مخاطر
          </h2>
          <p className="text-ivory/85 text-base md:text-lg leading-relaxed mb-8 max-w-2xl mx-auto">
            {customText ??
              "إن لم تلاحظ فرقاً خلال 30 يوماً، أعِد المنتج (حتى لو فارغاً) ونُعيد لك كامل مالك دون أي أسئلة. نحن عند كلمتنا."}
          </p>
            ...
            {[
              {
                ...
                desc: "لا تدفع شيئاً الآن — الدفع نقداً يداً بيد عند وصول الطرد إليك.",
              },
              {
                icon: Truck,
                title: "توصيل مجاني وسريع",
                desc: "لجميع مدن المغرب خلال 2-5 أيام عمل، دون أي تكلفة إضافية.",
              },
              {
                icon: Phone,
                title: "تأكيد سريع للطلب",
                desc: "نتواصل معك هاتفياً لتأكيد المعلومات وموعد التوصيل.",
              },
            ].map((p) => (
              <div
                key={p.title}
